---
description: Communicate the payment request to the final customer's MB WAY application without the need for a mobile phone number.
---

# MB WAY payment with registered mobile phone number
...
Obtaining the UUID of the payment method can be done via [View payment methods saved by the customer](../customers/getPaymentMethods.mdx)
