---
sidebar_position: 5
description: Guardar o método MB WAY para compras futuras
---
...
> **GET** ​/payments/\{id} <button className="btn-api btn-api--float-right btn-api--move-top" onClick={() => ClickShowIframe({ idMenuOption: "payments", idOption: "payments/get/payments/{id}"})}><span>View API &nbsp;&nbsp;&nbsp;{'>'}</span> </button>
