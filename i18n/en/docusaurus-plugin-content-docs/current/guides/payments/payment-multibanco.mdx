...
<button className="btn-api btn-api--float-right btn-api--move-top" onClick={() => ClickShowIframe({ idMenuOption: "payments", idOption: "payments/get/payments/{id}" })} ><span>View API &nbsp;&nbsp;&nbsp;{'>'}</span></button>
