---
description: Redirect the user to the membership form with pre-filled data.92
---
...
The complete data structure, as well as the options for _economicActivity_ and _availableMethods_ can be consulted <button className="link-api" onClick={ () => ClickShowIframe( {typeMenu: "model", idMenuOption: "models", idOption: "model/entityregistration"}) } > <span>here</span> </button>.
