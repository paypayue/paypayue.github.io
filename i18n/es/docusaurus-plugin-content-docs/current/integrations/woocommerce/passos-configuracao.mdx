...
Haga clic en la opción ‘Ajustes’ y rellene los campos con los datos de PayPay.pt, que puede obtener en ‘Configurar’ > ‘Integraciones’ > ‘Plataformas de Integración’ > ‘Añadir’ (Extensión WooCommerce), y al final, seleccione la opción ‘Guardar’.
