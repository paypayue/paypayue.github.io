---
sidebar_position: 2
title: 'Pasos de Configuración Zen Cart'
...
En esta área podrá ver los dos módulos de pago de la plataforma PayPay: Cajero Automático (Multibanco), Tarjeta de Crédito/Débito y MB WAY
...
Ahora su tienda puede generar y proporcionar datos de pago a sus clientes en tiempo real, según el método de pago seleccionado (cajero automático - Multibanco-, Tarjeta de Crédito/Débito o MB WAY).<br/>
