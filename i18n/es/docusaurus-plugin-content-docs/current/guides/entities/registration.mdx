...
La estructura de datos completa, así como las opciones de _economicActivity_ y _availableMethods_ pueden consultarse <button className="link-api" onClick={ () => ClickShowIframe( "model", "models", "model/entityregistration") } > <span>aquí</span> </button>.
