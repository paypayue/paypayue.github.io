...
La obtención del UUID del método de pago puede realizarse a través de [Consulta de los métodos de pago guardados por el cliente](../customers/getPaymentMethods.mdx)
