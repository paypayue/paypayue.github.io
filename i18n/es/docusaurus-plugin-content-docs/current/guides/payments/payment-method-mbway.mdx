---
description: Comunicar la solicitud de pago a la aplicación MB WAY del cliente final sin necesidad del número de teléfono móvil.
---

# Pago MB WAY con número de teléfono móvil registrado
