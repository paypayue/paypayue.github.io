...
- Pontos de venda que apenas precisam processar pagamentos
...
- Sistemas POS que precisam iniciar pagamentos remotamente
...
**Fluxo:**
1. apresentar o cartão através de um dos métodos:
