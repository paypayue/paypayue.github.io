...
## 2. Que acontece se uma operação for realizada com sucesso num terminal Cloud e o webhook não chegar atempadamente à PayPay?
...
## 3. Após um pagamento estar no estado "Settled", qual o prazo máximo para realizar uma devolução?

**Não existe período máximo** para realizar devoluções de pagamentos no estado "Settled".

:::info Recomendação
Embora não exista um prazo técnico máximo, recomendamos processar devoluções o mais cedo possível para melhor gestão financeira e experiência do cliente.
:::
