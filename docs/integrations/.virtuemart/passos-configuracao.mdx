---
sidebar_position: 2
title: 'Passos de Configuração VirtueMart'
...
![configuracao1](@site/_media/virtuemart-1.png)
...
![configuracao2](@site/_media/virtuemart-2.png)

Selecione a opção ‘Install from Web’ e introduza o nome da plataforma PayPay’.

![configuracao3](@site/_media/virtuemart-3.png)

Selecione o plugin da PayPay.

![configuracao4](@site/_media/virtuemart-4.png)

Clique em ‘Install’.

![configuracao5](@site/_media/virtuemart-5.png)
...
![configuracao9](@site/_media/virtuemart-9.png)
...
![configuracao10](@site/_media/virtuemart-10.png)
